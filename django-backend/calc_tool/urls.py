...
urlpatterns_users = [
    ...
    path('configurations/inputpage/<int:input_page_id>', ConfigurationView.as_view(), name='delete_view_with_id'),
...
urlpatterns_users += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
